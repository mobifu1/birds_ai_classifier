...
class BirdAITesterApp:
    ...
    # dann quadratisch gepaddet und auf 299x299 für das Modell gebracht.
    # =====================================================================
    ...
    def preprocess_image(self, file_path):
        ...
        3. Auf 299×299 für das Modell skalieren
        """
        ...
        # Schritt 3: Auf 299x299 skalieren
    ...
    def load_and_classify(self):
        ...
        # Bild vorverarbeiten (Kamera-Resize → Pad → 299x299)
        try:
