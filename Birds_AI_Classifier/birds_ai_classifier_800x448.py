...
class BirdAI:
    def __init__(self):
        # --- ÄNDERUNG: Neuer Modellname passend zum 800x448 Training ---
    ...
    def analyze_image(self, img_path):
        try:
            # --- ÄNDERUNG: Jetzt auf 800x448 (Breite 800, Höhe 448) ---
            # Keras load_img nutzt target_size=(height, width) -> also (448, 800)
